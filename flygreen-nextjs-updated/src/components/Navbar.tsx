    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-black/80 backdrop-blur-md">
      <nav className="flex justify-between items-center py-6 px-8 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex nav-links gap-8">
          <Link href="/" className={`${window.location.pathname === '/' ? 'active' : ''}`}>
            Home
          </Link>
          <Link href="/how-it-works" className={`${window.location.pathname === '/how-it-works' ? 'active' : ''}`}>
            How It Works
          </Link>
          <Link href="/technology" className={`${window.location.pathname === '/technology' ? 'active' : ''}`}>
            Technology
          </Link>
          <Link href="/impact" className={`${window.location.pathname === '/impact' ? 'active' : ''}`}>
            Impact
          </Link>
          <Link href="/community" className={`${window.location.pathname === '/community' ? 'active' : ''}`}>
            Community
          </Link>
        </div>
